  ...
  return (
    <DialogPortal>
      ...
      <div
        ...
        className={cn(
          "fixed top-1/2 left-1/2 z-50 grid w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl bg-background p-4 text-sm shadow-lg ring-1 ring-foreground/10 sm:max-w-sm",
          className
        )}
        {...props}
      >
        ...
        {showCloseButton && (
          <button
            ...
            data-slot="dialog-close"
            onClick={() => onOpenChange(false)}
            className="absolute top-2 right-2 rounded-md p-1 text-foreground/60 hover:text-foreground transition-colors"
